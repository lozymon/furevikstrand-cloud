...
export default function CertificationsPage() {
  ...
  const grouped = categoryOrder.reduce<Record<string, typeof certifications>>((acc, cat) => {
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-2 mt-auto">
                        <div className="flex items-center gap-2">
                          <span
                            className={`text-[10px] font-mono px-2 py-0.5 rounded border ${style.color} ${style.bg} ${style.border}`}
                          >
                            {cert.authority}
                          </span>
